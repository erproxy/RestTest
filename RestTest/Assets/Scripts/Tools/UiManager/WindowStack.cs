 ...
 public class WindowStack
    {
        ...
        {
            Debugger.Log($"Prepare stack with first window '{first.Name}'");
            Clear();
            Add(first);
        }
        ...
        public void Clear()
        {
            ...
            _lastWindow.Value = _visibleWindows.LastOrDefault(w => w.Priority != WindowPriority.TopPanel && w.Priority != WindowPriority.Debug);
        ...
        public void Add(Window window)
        {
            ...
            Debugger.Log($"Added window: '{windowName}' with priority {window.Priority}");
        ...
        public void Remove(Window window)
        {
            ...
            {
                string windowName = window.Name;
                Debugger.Log($"DestroyEnemy window '{windowName}'");
